You are managing the autonomous bootstrap of nest-asyncapi-native.
...
- `gh repo view --json nameWithOwner --jq .nameWithOwner` returns "nest-native/nest-asyncapi-native"
