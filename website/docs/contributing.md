...
Samples are documentation, validation, and onboarding material. Package changes
alter the public library contract. Keeping them separate makes each PR easier to
review, easier to revert, and safer to release.
