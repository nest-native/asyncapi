...
| [`02-validation-zod`](https://github.com/nest-native/asyncapi/tree/main/sample/02-validation-zod) | A Zod schema passed directly to `@AsyncApiMessage` | `npm run test --workspace nest-native-asyncapi-sample-02-validation-zod` |
