...
| [`02-validation-zod`](https://github.com/nest-native/asyncapi/tree/main/sample/02-validation-zod) | A Zod payload via `zod-to-json-schema` | `npm run test --workspace nest-native-asyncapi-sample-02-validation-zod` |
